...
ggplot(data=world,aes(fill=difference)) +
  geom_sf()+
...
ggplot(data=world_lim,aes(fill=difference)) +
  geom_sf()+
...
ggsave(plot,filename = "C:/Users/morit/OneDrive - Nexus365/Covid-19 Paper/Figures/Map_Projection_SIR.pdf",device = cairo_pdf,height=6,width = 10)
ggsave(plot,filename = "C:/Users/morit/OneDrive - Nexus365/Covid-19 Paper/Figures/Map_Projection_SIR.jpg",height=6,width = 10)
