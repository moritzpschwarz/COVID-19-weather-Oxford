...
for(j in 1:length(model_assumptions$R0_input)){
  ...
  ggsave(plot,filename = paste0("C:/Users/morit/OneDrive - Nexus365/Covid-19 Paper/Figures/Level Projections_R0",model_assumptions$R0_input[j],"_Apr04.pdf"),device = cairo_pdf,height = 8,width = 10)
  ggsave(plot,filename = paste0("C:/Users/morit/OneDrive - Nexus365/Covid-19 Paper/Figures/Level Projections_R0",model_assumptions$R0_input[j],"_Apr04.jpg"),height = 8,width = 10)
}
...
#   labs(title = "Old Version - Linearized Coef: 0.0031",y="Growth",
